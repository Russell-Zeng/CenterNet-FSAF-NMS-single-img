...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 20 or dataset == 'coco':
    # elif num_classes == 1 or dataset == 'coco':
      self.names = coco_class_name
    # elif num_classes == 20 or dataset == 'pascal':  # 注释掉这两行，避免这两个num_classes == 20起冲突
  ...
  def add_coco_bbox(self, bbox, cat, conf=1, show_txt=True, img_id='default'):
    ...
    txt = '{}{:.3f}'.format(self.names[cat], conf) # 置信度显示到小数点后几位
...
'''
# coco_class_name = ['bad_ring', 'topring', 'btmring']
# coco_class_name = ['ring', 'bad_ring', 'pull_ring']
# coco_class_name = ['破洞', '水渍_油渍_污渍', '三丝', '结头', '花板跳', '百脚', '毛粒', '粗经', '松经', '断经', '吊经', '粗维', '纬缩', '浆斑', '整经结', '星跳_跳花', '断氨纶', '稀密档_浪纹档_色差档', '磨痕_轧痕_修痕_烧毛痕', '死皱_云织_双维_双经_跳纱_筘路_纬纱不良']
# coco_class_name = ['ring']
coco_class_name = ["aeroplane", "bicycle", "bird", "boat", "bottle", "bus",
  "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike",
  "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor"]
color_list = np.array(
        [

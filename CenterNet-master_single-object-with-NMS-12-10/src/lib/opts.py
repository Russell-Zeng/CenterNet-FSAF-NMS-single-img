...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_id', default='coco_dla_obj_pixel_loss_12_14') #　exp_id只是一个名字，为了区分每次实验，没有特别的作用
    ...
    self.parser.add_argument('--demo', default='/home/zy/zy/2new_network/CenterNet-master_single-object-withNMS/data/coco/images/mini-testset',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')   # 这个参数是用来做演示的
    # default='/home/zy/zy/2new_network/CenterNet-master_single-object-withNMS/exp/ctdet/coco_dla_obj_dla_11-14/model_best.pth'

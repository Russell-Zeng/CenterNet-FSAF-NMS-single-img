...
def _gather_feat(feat, ind, mask=None):
    # print(11111111111, feat.size(), ind.size())  # torch.Size([1, 16384, 2]) torch.Size([1, 128])
    dim  = feat.size(2)
    ind  = ind.unsqueeze(2).expand(ind.size(0), ind.size(1), dim)
    # print(22222222222, feat.size(), ind.size())  # torch.Size([1, 16384, 2]) torch.Size([1, 128, 2])
    feat = feat.gather(1, ind)   #  Gathers values along an axis specified by dim.
    # print(33333333333, feat.size())     # torch.Size([1, 128, 2])
    if mask is not None:

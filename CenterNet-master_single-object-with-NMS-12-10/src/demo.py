...
def demo(opt):
  ...
  if opt.demo == 'webcam' or \
    ...
    for (image_name) in image_names:
      ...
      res_list = res_dict[15].tolist()  # array数据转换成列表
      bbox_list = []
      ...
      save_path = os.path.join('/home/zy/zy/2new_network/CenterNet-master_single-object-withNMS/testimg_result', image_name.split('/')[-1])

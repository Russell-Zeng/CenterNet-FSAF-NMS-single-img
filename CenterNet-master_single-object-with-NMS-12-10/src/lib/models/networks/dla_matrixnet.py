...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.up_delta_conv = nn.Conv2d(3, 64, kernel_size=3, stride=(1, 2), padding=0, bias=False, dilation=1)

        self.btm_delta_conv = nn.Conv2d(3, 64, kernel_size=3, stride=(2, 1), padding=0, bias=False, dilation=1)
    ...
    def forward(self, x):
        ...
        y0_up_1 = self.up_delta_con(y[0])
        print('y0_up_1:', y0_up_1.size())
        y0_up_2 = self.up_delta_con(y0_up_1)
        print('y0_up_2:', y0_up_2.size())
        y0_btm_1 = self.up_delta_con(y[0])
        print('y0_btm_1:', y0_btm_1.size())
        y0_btm_2 = self.up_delta_con(y0_btm_1)
